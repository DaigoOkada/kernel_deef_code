#gene wise calculation la,bda in other seed
##python /home/dokada/Dropbox/analysis/2021.7/uc_seed3_0518.py
import pandas as pd
import numpy as np
import  os
import shutil
...
#ファイルパスの設定
out_path = "/home/dokada/work_dir/uc_seed3/"

...
#Out path
out_path = "/home/dokada/work_dir/aml_ML/"
...
data_path = "/home/dokada/work_dir/aml_kdeef/"
prdct_mat = np.zeros([iters, 180])
prdct_mat_prob = np.zeros([iters, 180])
cv_iter_testacc = np.zeros(iters)
for k in range(iters):
    feature_names = list()
    for d in range(len(doses)):
        dos = doses[d]
        Xtrain_file = "tube" + dos + "_Xtrain1_iter" + str(k) + ".csv"
        ytrain_file = "tube" + dos + "_ytrain1_iter" + str(k) + ".csv"
        Xtest_file = "tube" + dos + "_Xtest1_iter" + str(k) + ".csv"
        ytest_file = "tube" + dos + "_ytest1_iter" + str(k) + ".csv"
